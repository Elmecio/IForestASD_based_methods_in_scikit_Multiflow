...
class NDKSWINIsolationForestStream(BaseSKMObject, ClassifierMixin):
...
self.n_estimators
  ...
  def update_model(self,window):
    ...
    #print("self.prec_window pour dans update_model")
    #print(window)
    ## ToDo ? Give a sample of self.window_size in attribute of iForest
