...
class IsolationForestADWINStream(BaseSKMObject, ClassifierMixin):
...
self.n_estimators
  ...
  def __init__(self, window_size=100, n_estimators=25, anomaly_threshold=0.5, drift_threshold=0.5, random_state=None, version="AnomalyRate"):
  ...
  def update_model(self,window):
    ...
    print("iForest ASD Update the model by training a new iForest with the version : "+self.version)
